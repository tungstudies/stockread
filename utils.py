...
def yaml_loader(filepath):
    """Load a yaml file at the given filepath.
    ...
    with open(filepath) as file_descriptor:
        data = yaml.load(file_descriptor, Loader=yaml.BaseLoader)
        return data
...
if __name__ == '__main__':
    ...
    usertime = '2021-01-26T04:26:03+00:00'
    date = time_ago(usertime=usertime)
    print(date)


    # print(datetime.datetime.strptime('2021-01-26T04:26:03+00:00', '%Y-%m-%dT%H:%M:%S'))
    pass
